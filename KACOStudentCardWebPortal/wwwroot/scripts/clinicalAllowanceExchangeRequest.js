jQuery(document).ready(function () {
    //debugger;
    jQuery('#clinicalAllowanceExchangeRequestForm')[0].reset();
...
function sendClinicalAllowanceExchangeRequest() {
    //debugger;
    ...
    if (document.getElementById('FullName').value === "") {
        ...
        bootbox.alert("من فضلك أرفق شهادة قيد المرحلة الإكلينيكية");
        return false;
    }
    ...
    jQuery.ajax({
        url: '/Service/PostClinicalAllowanceExchange',
        type: 'POST',
        ...
        success: function (data) {
            if (data.err === "") {
                ...
                bootbox.alert({
                    ...
                    message: "سيتم التواصل معكم فى حالة وجود مشكلة بالطلب. يرجى مراجعة المكتب الثقافى بالأسكندرية فى حالة عدم صرف البدل الإكلينيكى خلال ثلاثة أسابيع. شكرا" ,
